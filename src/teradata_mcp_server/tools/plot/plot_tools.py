...
def handle_generate_line_plot(conn: TeradataConnection, table_name: str, labels: str, columns: List[str]):
    """
...
def handle_generate_radar_plot(conn: TeradataConnection, table_name: str, labels: str, columns: List[str]):
    """
