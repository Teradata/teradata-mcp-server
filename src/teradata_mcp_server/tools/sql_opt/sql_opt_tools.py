...
def handle_sql_Execute_Full_Pipeline(conn, optimal_k: int = None, max_queries: int = None, *args, **kwargs):
    """
...
def handle_sql_Analyze_Cluster_Stats(conn, sort_by_metric: str = "avg_cpu", limit_results: int = None, *args, **kwargs):
    """
